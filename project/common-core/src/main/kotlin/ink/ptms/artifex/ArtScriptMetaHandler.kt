 ...
 */
object ArtScriptMetaHandler : ScriptMetaHandler {
    ...
    override fun getScriptMetaData(file: File): ScriptMetaData {
        return getScriptMetaData(ZipFile(file).toFileSet())
    }

    override fun getScriptMetaData(fileSet: FileSet): ScriptMetaData {
        ...
        return ScriptMetaData(metaFile.getInt("version.compiler"), metaFile)
    }

    override fun getScriptMetaData(zipInputStream: ZipInputStream): ScriptMetaData {
        return getScriptMetaData(zipInputStream.toFileSet())
    }
